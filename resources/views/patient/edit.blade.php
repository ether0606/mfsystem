    ...
    <div class="col-xs-12">
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Patient Update Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route(currentUser().'.patient.update',$patient->id)}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
					@method('PUT')
						<div class="row">
							<div class="col-xs-12 col-sm-6">
								<div class="form-group @if($errors->has('name')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="name" value="{{$patient->name}}">
										@if($errors->has('name')) 
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group @if($errors->has('patient_occupation')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="patient_occupation" value="{{$patient->patient_occupation}}">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-6">
								<div class="form-group @if($errors->has('father')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="father" value="{{$patient->father}}">
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group @if($errors->has('father_occupation')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="father_occupation" value="{{$patient->father_occupation}}">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-6">
								<div class="form-group @if($errors->has('mother')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="mother" value="{{$patient->mother}}">
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group @if($errors->has('mother_occupation')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="mother_occupation" value="{{$patient->mother_occupation}}">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-6">
								<div class="form-group @if($errors->has('disease_name')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="disease_name" value="{{$patient->disease_name}}">
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group @if($errors->has('disease_description')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="disease_description" value="{{$patient->disease_description}}">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-3">
								<div class="form-group">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="hospital_name" value="{{$patient->hospital_name}}">
									</span>
								</div>
							</div>
							<div class="col-xs-12 col-sm-3">
								<div class="form-group">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="doctor_name" value="{{$patient->doctor_name}}">
									</span>
								</div>
							</div>
							<div class="col-xs-12 col-sm-3">
								<div class="form-group @if($errors->has('treatment_cost')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="treatment_cost" value="{{$patient->treatment_cost}}">
							...
							<div class="col-xs-12 col-sm-3">
								<div class="form-group @if($errors->has('apply_amount')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="apply_amount" value="{{$patient->apply_amount}}">
							...
							<div class="col-xs-12 col-sm-3">
								<div class="form-group @if($errors->has('age')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="age" value="{{$patient->age}}">
										@if($errors->has('age')) 
											<i class="ace-icon fa fa-times-circle"></i>
										@endif
									</span>
										...
										<select onchange="this.value=='1'?$('.spouse_name').show():$('.spouse_name').hide() " class="width-100" name="marital_status">
											...
											@if($marital_status)
												@foreach($marital_status as $i=>$s)
													<option value="{{$i}}" @if($i==$patient->marital_status) selected @endif>{{$s}}</option>
												@endforeach
											@endif
										</select>
							...
							<div class="col-xs-12 col-sm-6 spouse_name" @if($patient->marital_status==0) style="display:none" @endif>
								<div class="form-group">
									<label>Spouse Name</label>
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="spouse_name" value="{{$patient->spouse_name}}">
									</span>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-6">
								<div class="form-group @if($errors->has('present_address')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<textarea class="width-100" name="present_address">{{$patient->present_address}}</textarea>
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group @if($errors->has('permanent_address')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<textarea class="width-100" name="permanent_address">{{$patient->permanent_address}}</textarea>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-4">
								<div class="form-group @if($errors->has('contact')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="contact" value="{{$patient->contact}}">
							...
							<div class="col-xs-12 col-sm-4">
								<div class="form-group">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="alt_contact" value="{{$patient->alt_contact}}">
									</span>
								</div>
							</div>
							<div class="col-xs-12 col-sm-4">
								<div class="form-group">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="family_member" value="{{$patient->family_member}}">
									</span>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-4">
								<div class="form-group @if($errors->has('nid_birthid')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="nid_birthid" value="{{$patient->nid_birthid}}">
								...
								<div class="form-group @if($errors->has('status')) has-error @endif">
									...
									@php $status=array('Inactive','active','Pending','Freez','Block'); @endphp
										<select class="width-100" name="status">
											...
											<option value="{{$i}}" @if($i==$patient->status) selected @endif>{{$s}}</option>
												@endforeach
											@endif
										</select>
